...
class DiscriminatorLoss(nn.Module):
    ...
    def forward(self, disc_real_output, disc_generated_output):
        ...
        generated_loss = self.loss_object(torch.zeros_like(disc_generated_output), disc_generated_output)
...
class GeneratorLoss(nn.Module):
    ...
    def forward(self, disc_generated_output, gen_output, target):
        gen_loss = self.bce_loss(torch.ones_like(disc_generated_output), disc_generated_output)
